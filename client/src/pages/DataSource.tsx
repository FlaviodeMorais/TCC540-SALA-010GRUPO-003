...
export default function DataSource() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <Tabs value="config" className="space-y-4">
        ...
        {/* Tab: Emulador - Oculto */}
        <TabsContent value="emulator" className="hidden space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="space-y-5">
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            {/* Opção "Cenário" removida conforme solicitado */}
                          </SelectContent>
                        </Select>
                      </div>
                ...
                {/* Cenários Pré-definidos - Removido conforme solicitação */}
                {/* 
                  O card de cenários foi removido da interface, mas a funcionalidade 
                  continua disponível no backend para manter a compatibilidade do sistema
                */}
